...
<section className="mx-auto mt-32 max-w-7xl">
  <div className="rounded-3xl bg-foreground p-8 text-background md:p-12">
    <div className="grid gap-12 md:grid-cols-[0.8fr_1.2fr]">
      <div>
        <div className="mb-6 flex items-center gap-3 text-sm font-bold uppercase tracking-[0.14em] text-background/70">
          <IconLightbulb className="size-4" />
          Project Goals
        </div>

        <h2 className="max-w-xl text-3xl font-semibold leading-tight tracking-[-0.04em] md:text-5xl">
          Create a lightweight system for organizing docs by topic, workflow, and ownership.
        </h2>

        <p className="mt-8 text-lg leading-8 text-background/75 md:text-xl md:leading-9">
          The project was prioritized after feedback from paying customers, requests from the Slack community, and a need to make documentation easier to browse at scale.
        </p>
      </div>

      <div className="grid gap-4">
        <div className="rounded-3xl border border-background/15 bg-background/10 p-6">
          <div className="mb-4 flex size-11 items-center justify-center rounded-full bg-background/10 text-background">
          ...
          <p className="mt-3 text-lg leading-8 text-background/70">
        ...
        <div className="rounded-3xl border border-background/15 bg-background/10 p-6">
          ...
          <h3 className="text-xl font-semibold tracking-[-0.03em]">
            Ship in focused phases
          </h3>

          <p className="mt-3 text-lg leading-8 text-background/70">
            Start with tagging in the editor, then expand the pattern into filtering and table management.
          </p>
        </div>
      </div>
    </div>
  ...
  <div className="grid gap-12 md:grid-cols-[0.8fr_1.2fr]">
    <div>
      ...
      <h2 className="max-w-xl text-3xl font-semibold leading-tight tracking-[-0.04em] text-foreground md:text-5xl">
        We introduced tagging through three connected release phases.
      </h2>
...
<section className="mx-auto mt-32 max-w-7xl">
  <div className="grid gap-10 rounded-3xl border border-foreground/15 bg-card p-8 md:grid-cols-[0.9fr_1.1fr] md:p-12">
    <div>
